...
class __TwigTemplate_1d534d962048c128eb6a52667bc7f2488bb7881c2c9e3373f7ded6b26c19d14a extends \Twig\Template
{
...
\t<h4><label>";
        // line 22
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["strings"] ?? null), "post_translations", []), "position_label", []), "html", null, true);
        echo "</label>  ";
...
\t\t\t\t\t   value=\"1\"";
        ...
        echo ">";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["strings"] ?? null), "post_translations", []), "position_above", []), "html", null, true);
        echo "
\t\t\t</label>
\t\t</li>
\t\t<li>
...
\t\t\t\t\t   value=\"1\"";
        ...
        echo ">";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["strings"] ?? null), "post_translations", []), "position_below", []), "html", null, true);
        echo "
\t\t\t</label>
\t\t</li>
\t</ul>
...
\t<h4><label>";
        // line 46
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["strings"] ?? null), "post_translations", []), "label_alternative_languages_text", []), "html", null, true);
        echo "</label>  ";
...
\t\t   name=\"statics[post_translations][availability_text]\" value=\"";
    ...
    {
        return array (  111 => 48,  104 => 46,  101 => 45,  98 => 44,  95 => 43,  92 => 42,  89 => 41,  87 => 40,  75 => 35,  61 => 28,  50 => 22,  47 => 21,  45 => 18,  44 => 17,  43 => 14,  40 => 13,  38 => 9,  37 => 5,  32 => 2,  30 => 1,);
    }
    ...
    {
        return new Source("", "slot-subform-statics-post_translations.twig", "/Users/francescogrieco/Desktop/projects/bebit/wp-content/plugins/sitepress-multilingual-cms/templates/language-switcher-admin-ui/slot-subform-statics-post_translations.twig");
    }
}
